package com.aranha.spider.app.mjpeg;
...
import com.aranha.spider.app.BluetoothDiscoverDevicesActivity;
import com.aranha.spider.app.BluetoothService;
import com.aranha.spider.app.ConnectionSelect;
import com.aranha.spider.app.MainActivity;
import com.aranha.spider.app.SpiderController;
import com.aranha.spider.app.SpiderControllerService;
import com.example.spider.app.R;

/**
 * The activity which is used to connect to the Raspberry Pi.
 */
public class ConnectActivityOld extends ActionBarActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (SpiderController.SpiderMessages[msg.what]) {
                ...
                case CONNECTING_FAILED:
                    Toast.makeText(ConnectActivityOld.this, "Failed to connect to the spider!", Toast.LENGTH_LONG).show();
                ...
                case CONNECTED_TO_RASPBERRYPI:
                    ...
                    Intent mainActivityIntent = new Intent(new Intent(ConnectActivityOld.this, MainActivity.class));
                    mainActivityIntent.putExtra("ServiceClass", mSelectedConnectServiceClass.getName());
                    startActivity(mainActivityIntent);
                    Toast.makeText(ConnectActivityOld.this, "Connected to the spider!", Toast.LENGTH_LONG).show();
                    break;
                ...
                case CONNECTION_LOST:
                    ...
                    if(mServiceIsConnected)
                        mConnectService.discoverDevices();
                    Toast.makeText(ConnectActivityOld.this, "Lost connection to the spider.", Toast.LENGTH_LONG).show();
                    break;
            }
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            startActivity(new Intent(ConnectActivityOld.this, BluetoothDiscoverDevicesActivity.class));
            return true;
        }
        else if(id == 16908332 /* R.id.home doesn't work*/ ) {
            unbindService();
            startActivity(new Intent(ConnectActivityOld.this, ConnectionSelect.class));
        }
